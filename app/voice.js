...
const styles = StyleSheet.create({
  ...
  recordTime: { color: colors.textFaint, fontSize: 12, fontFamily: "monospace", width: 40, textAlign: "right" },
  recordHint: { color: colors.textFaint, fontSize: 12 },
  ...
  digestSub: { color: colors.textFaint, fontSize: 11.5, marginTop: 1 },
  ...
  digestScript: { color: colors.textSecondary, ...type.body, fontSize: 14 },
  ...
  historyResponse: { color: colors.textSecondary, fontSize: 12.5, marginTop: 2, lineHeight: 17 },
  historyTime: { color: colors.textFaint, fontSize: 10.5 },
