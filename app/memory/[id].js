...
const styles = StyleSheet.create({
  ...
  copiedText: { color: colors.success, fontSize: 13, fontWeight: "600", marginTop: 6, textAlign: "right" },
  ...
  audioTime: { color: colors.textFaint, fontSize: 13, fontFamily: "monospace", width: 38, textAlign: "right" },
  ...
  privacyActionText: { color: colors.textSecondary, fontSize: 13, fontWeight: "600" },
  askButton: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
