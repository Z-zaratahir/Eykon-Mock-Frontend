...
const styles = StyleSheet.create({
  ...
  sourceBadgeText: { color: colors.white, fontSize: 13, fontWeight: "600", flexShrink: 1 },
  ...
  modeSwitchText: { color: "rgba(255,255,255,0.55)", fontSize: 13, fontWeight: "700", letterSpacing: 1 },
  ...
  hintText: { color: "rgba(255,255,255,0.7)", fontSize: 13, marginTop: spacing.md },
  toast: {
    position: "absolute",
    top: "42%",
    alignSelf: "center",
