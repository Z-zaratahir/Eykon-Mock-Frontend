...
const styles = StyleSheet.create({
  ...
  disconnectedText: { color: colors.textSecondary, fontSize: 12, marginTop: 2, lineHeight: 16 },
  ...
  deviceMeta: { color: colors.textFaint, fontSize: 11.5, marginTop: 2 },
  ...
  batteryRingLabel: { color: colors.textPrimary, fontSize: 12, fontWeight: "800" },
  storageBarWrap: {},
  storageBarHeaderRow: { flexDirection: "row", justifyContent: "space-between", marginBottom: 4 },
  storageLabel: { color: colors.textSecondary, fontSize: 11.5 },
  storageValue: { color: colors.textFaint, fontSize: 11 },
  ...
  tempText: { color: colors.textSecondary, fontSize: 11.5 },
  ...
  sourceOptionSub: { color: colors.textFaint, fontSize: 10 },
  sourceHint: { color: colors.textFaint, fontSize: 12, marginTop: 8, lineHeight: 16 },
  modeList: { gap: 8 },
  modeRow: {
    flexDirection: "row",
    alignItems: "center",
  ...
  modeRowDesc: { color: colors.textFaint, fontSize: 11.5, marginTop: 2 },
  ...
  toggleDesc: { color: colors.textFaint, fontSize: 11.5, marginTop: 3, lineHeight: 15 },
  pipelineRow: {
    flexDirection: "row",
    alignItems: "flex-start",
