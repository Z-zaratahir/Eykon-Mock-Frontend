...
const styles = StyleSheet.create({
  ...
  keepToggleLabel: { color: colors.white, fontSize: 11.5, fontWeight: "600" },
  ...
  askCaption: { color: colors.white, fontSize: 12, fontWeight: "600" },
  sheet: {
    position: "absolute",
    left: 0,
    right: 0,
  ...
  sheetQ: { color: colors.textFaint, fontSize: 12, fontStyle: "italic" },
  ...
  notSavedText: { color: colors.textFaint, fontSize: 11.5, textAlign: "center", paddingBottom: 4 },
});
